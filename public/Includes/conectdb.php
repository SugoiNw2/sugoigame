<?php
require_once __DIR__ . "/database/mywrap.php";
...
$conect = mysql_connect(DB_SERVER, DB_USER, DB_PASS)
    or die("Erro mysql_connect: " . mysql_error());

mysql_select_db(DB_NAME, $conect)
    or die("Erro mysql_select_db: " . mysql_error());
...
$result = $connection->run(
    "SELECT 1 FROM tb_ban WHERE ip = ? LIMIT 1",
    "s",
    [$ip]
);
...
require_once __DIR__ . "/../Funcoes/requires.php";
